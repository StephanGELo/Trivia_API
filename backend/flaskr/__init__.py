...
def create_app(test_config=None):
    ...
    '''
    @TODO 1: Set up CORS. Allow '*' for origins.
    ...
    def get_quiz_question():
        ...
        try:
            ...
            if quiz_category['id'] > 0:
                ...
                # Otherwise,check if selected question exists in
                # previous questions
                else:
                    ...
                    # If selected question does not exist in previous
                    # questions,append it and return it to the frontend
